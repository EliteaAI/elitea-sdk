...
4.  **Present for Approval:**
    ...
    *   Show the user exactly what will be posted, including:
        ...
        *   The exact destination: `EliteaAI/elitea.github.io`
...
5.  **Post to GitHub Board:**
    *   Only after receiving explicit approval from the user, create the issue in **`EliteaAI/elitea.github.io`** (this is what routes it to the Project board).
    ...
    *   **POST-CREATE VERIFICATION (MANDATORY):**
        ...
        *   If you accidentally created the issue in the wrong repository:
            *   Create the correct issue in `EliteaAI/elitea.github.io`.
