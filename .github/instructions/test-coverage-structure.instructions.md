---
description: Test coverage report structure and formatting guidelines for ELITEA SDK
applyTo: ".elitea/tests/test_pipelines/test_coverage.md"
---

# Test Coverage Report Structure

This document defines the required structure and formatting for the ELITEA SDK test coverage report located at `.elitea/tests/test_pipelines/test_coverage.md`.

## Report Location

**File**: `.elitea/tests/test_pipelines/test_coverage.md`
...
```markdown
# ELITEA SDK Test Coverage Analysis
...
**Location**: `elitea_sdk/tools/<toolkit>/api_wrapper.py`
...
*Note: This analysis is based on test files in `.elitea/tests/test_pipelines/suites/` and tool implementations in `elitea_sdk/tools/` and `elitea_sdk/runtime/tools/`*
```
...
- **Toolkit source**: `` `elitea_sdk/tools/<toolkit>/api_wrapper.py` ``
- **Test suites**: `` `.elitea/tests/test_pipelines/suites/<suite>/tests/` ``
...
3. **Toolkit Count**: Count directories in `elitea_sdk/tools/` with wrappers (excluding framework utilities)
...
**Location**: `elitea_sdk/tools/postman/api_wrapper.py`
...
- This structure is based on the current report at `.elitea/tests/test_pipelines/test_coverage.md`
