...
| Loader | Test file |
|--------|-----------|
| `EliteATextLoader` | `test_elitea_text_loader.py` |
| `EliteACSVLoader` | `test_elitea_csv_loader.py` |
| `EliteAJSONLoader` | `test_elitea_json_loader.py` |
| `EliteAMarkdownLoader` | `test_elitea_markdown_loader.py` |
...
All `pytest` commands below assume the venv is active and the working directory is the project root (`elitea-sdk/`).
...
```bash
python -m pytest tests/runtime/langchain/document_loaders/test_elitea_text_loader.py -v
python -m pytest tests/runtime/langchain/document_loaders/test_elitea_csv_loader.py -v
python -m pytest tests/runtime/langchain/document_loaders/test_elitea_json_loader.py -v
python -m pytest tests/runtime/langchain/document_loaders/test_elitea_markdown_loader.py -v
```
...
python -m pytest tests/runtime/langchain/document_loaders/test_elitea_text_loader.py::test_loader[text_simple-config0] -v
```
...
| Mark | Triggers when |
|------|--------------|
| `loader_text` | Any change to `EliteATextLoader` |
| `loader_csv` | Any change to `EliteACSVLoader` |
| `loader_json` | Any change to `EliteAJSONLoader` |
| `loader_markdown` | Any change to `EliteAMarkdownLoader` |
...
RP_LAUNCH=EliteA SDK Loader Tests    # display name for the launch in RP
```
...
python -m pytest tests/runtime/langchain/document_loaders/test_elitea_text_loader.py --reportportal -v
...
python -m pytest tests/runtime/langchain/document_loaders/test_elitea_text_loader.py::test_loader[text_simple-config0] -v -s
```
...
LOADER = "EliteATextLoader"   # change as needed
