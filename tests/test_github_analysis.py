...
from ..elitea_sdk.community.analysis.github_analyse.api_wrapper import (
  GetGithubCommitsFromReposArgs, GetGithubRepositoriesListArgs, GitHubAnalyseWrapper
)

from ..elitea_sdk.clients.client import EliteAClient
from ..elitea_sdk.tools.artifact import ArtifactWrapper
...
def test_get_repositories_list(github_api_wrapper):
    with patch(
        "src.elitea_sdk.community.analysis.github_analyse.api_wrapper.dispatch_custom_event",
        return_value=None,
    ):
