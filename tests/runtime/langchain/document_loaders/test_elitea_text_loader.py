"""
Pytest tests for EliteATextLoader.

Test cases are auto-discovered from:
  tests/runtime/langchain/document_loaders/test_data/EliteATextLoader/input/*.json
...
Run:
  ...
  pytest tests/runtime/langchain/document_loaders/test_elitea_text_loader.py -v -k "text_simple"
