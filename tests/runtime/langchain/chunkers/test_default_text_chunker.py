"""
Unit tests for elitea_sdk.tools.chunkers.universal_chunker._default_text_chunker.
...
from elitea_sdk.tools.chunkers.universal_chunker import _default_text_chunker
