"""
Unit tests for elitea_sdk.tools.chunkers.sematic.statistical_chunker.
...
from elitea_sdk.tools.chunkers.sematic.statistical_chunker import (
    statistical_chunker,
...
class TestSCH05_InternalHelpers:
    ...
    def test_split_documents_no_tokens_lost(self):
        ...
        from elitea_sdk.tools.chunkers.utils import tiktoken_length
        docs = ["hello world"] * 10
        similarities = [0.5] * 9
    ...
    def test_split_documents_returns_list_of_chunks(self):
        from elitea_sdk.tools.chunkers.sematic.base import Chunk
