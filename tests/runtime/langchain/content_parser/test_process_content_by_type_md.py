...
_MD_SIMPLE = _TEST_DATA / "EliteAMarkdownLoader" / "files" / "markdown_simple.md"
_MD_LARGE  = _TEST_DATA / "EliteAMarkdownLoader" / "files" / "markdown_large.md"
...
class TestChunkingConfigMd:
    ...
    def test_smaller_max_tokens_produces_more_chunks(self):
        ...
        The override must reach EliteAMarkdownLoader's chunker_config so the
        ...
        Tracked: https://github.com/EliteaAI/elitea.github.io/issues/3823
        """
