...
chunking_config
  ...
  EliteAJSONLinesLoader inherits max_tokens handling from EliteAJSONLoader and
  ...
  Key behavior: each non-empty line is processed by a per-line EliteAJSONLoader
...
_JSONL_SIMPLE  = _TEST_DATA / "EliteAJSONLinesLoader" / "files" / "jsonl_simple.jsonl"
_JSONL_LARGE   = _TEST_DATA / "EliteAJSONLinesLoader" / "files" / "jsonl_large.jsonl"
_JSONL_EMPTY   = _TEST_DATA / "EliteAJSONLinesLoader" / "files" / "jsonl_empty.jsonl"
_JSONL_UNICODE = _TEST_DATA / "EliteAJSONLinesLoader" / "files" / "jsonl_unicode.jsonl"
