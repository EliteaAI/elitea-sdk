...
class PPTXWrapper(BaseToolApiWrapper):
    ...
    Uses the EliteA artifact API to download and upload PPTX files from/to buckets.
    """
    bucket_name: str
    elitea: Any  # EliteAClient
    ...
    def _download_pptx(self, file_name: str) -> str:
        ...
        try:
            ...
            data = self.elitea.download_artifact(self.bucket_name, file_name)
            if isinstance(data, dict) and data['error']:
        ...
        try:
            ...
            if pdf_file_name:
                try:
                    ...
                    pdf_data = self.elitea.download_artifact(self.bucket_name, pdf_file_name)
