...
class ConfluenceAPIWrapper(NonCodeIndexerToolkit):
    ...
    def _base_loader(self, **kwargs) -> Generator[Document, None, None]:
        ...
        loader = EliteAConfluenceLoader(self.client, self.llm, bins_with_llm, **confluence_loader_params)
    ...
    def _upload_file_from_artifact(self, page_id: str, filepath: str, filename: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if not self.elitea:
                raise ToolException("EliteA client is not initialized. Cannot download artifact.")
