...
class SharepointGraphWrapper(BaseSharepointWrapper):
    ...
    Args:
        ...
        elitea: Optional EliteA client for artifact resolution.
    ...
    def _resolve_drive_and_folder(self, folder_path: str) -> List[Tuple[str, str]]:
        ...
        * Non-default document libraries::
            ...
            '/sites/MySite/EliteA_test/subfolder'
            → [(elitea_test_drive_id, 'subfolder')]

            '/sites/MySite/EliteA_test'
            → [(elitea_test_drive_id, '')]
        ...
        * Bare subfolder name not matching any library (e.g. ``"test"``)::
        ...
        # "Shared Documents/upload" or "EliteA_test/subfolder"
    ...
    def upload_file(self, folder_path: str, filepath: Optional[str] = None,
        ...
        #   2. Non-default libraries (e.g. "EliteA_test") were silently routed to
