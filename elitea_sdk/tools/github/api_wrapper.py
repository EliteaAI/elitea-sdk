...
class EliteAGitHubAPIWrapper(CodeIndexerToolkit):
    """
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        github_client = GitHubClient(auth_config=auth_config, repo_config=repo_config, elitea=values.get("elitea"))
