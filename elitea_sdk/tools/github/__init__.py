...
def get_toolkit(tool) -> BaseToolkit:
    return EliteAGitHubToolkit().get_toolkit(
...
class EliteAGitHubToolkit(BaseToolkit):
    tools: List[BaseTool] = []

    @staticmethod
    def toolkit_config_schema() -> BaseModel:
        available_tools = EliteAGitHubAPIWrapper.model_construct().get_available_tools()
    ...
    def get_toolkit(cls, selected_tools: list[str] | None = None, toolkit_name: Optional[str] = None, **kwargs):
        ...
        github_api_wrapper = EliteAGitHubAPIWrapper(**wrapper_payload)
