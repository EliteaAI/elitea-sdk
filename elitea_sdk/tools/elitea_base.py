...
BaseSearchParams = build_base_search_params(cut_off_default=0.5)
BaseStepbackSearchParams = build_base_stepback_search_params(cut_off_default=0.5)
...
class BaseVectorStoreToolApiWrapper(BaseToolApiWrapper):
    ...
    def __init__(self, **kwargs):
        ...
        if self.elitea and self.embedding_model:
            self._embedding = self.elitea.get_embeddings(self.embedding_model)
    ...
    def index_data(self, **kwargs):
        from elitea_sdk.tools.chunkers import __confluence_chunkers__ as chunkers, __confluence_models__ as models
    ...
    def edit_file(
        ...
        try:
            ...
            if not isinstance(current_content, str):
                raise ToolException(str(current_content))
        except Exception as e:
