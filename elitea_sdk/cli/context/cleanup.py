...
def get_sessions_dir(elitea_dir: str = '.elitea') -> Path:
    """
    Get the sessions directory path.
    
    Args:
        elitea_dir: Base EliteA directory
        
    Returns:
        Path to sessions directory
    """
    # Expand ~ for home directory
    if elitea_dir.startswith('~'):
        elitea_dir = os.path.expanduser(elitea_dir)
    return Path(elitea_dir) / 'sessions'


def list_sessions_with_age(elitea_dir: str = '.elitea') -> List[Tuple[str, float, datetime]]:
    """
    ...
    """
    sessions_dir = get_sessions_dir(elitea_dir)
...
def purge_old_sessions(
    ...
    sessions = list_sessions_with_age(elitea_dir)
...
def get_session_disk_usage(elitea_dir: str = '.elitea') -> Tuple[int, int]:
    """
