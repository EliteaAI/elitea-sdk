"""
EliteA SDK Community Module

This module contains community extensions and utilities for the EliteA SDK.
...
def get_tools(tools_list: list, elitea_client, llm) -> list:
        ...
        if class_name and class_name in globals():
            try:
                ...
                if tool_type == 'inventory':
                    ...
                    # Inject elitea and llm into api_wrapper for each tool
                    for t in inventory_tools:
                        if hasattr(t, 'api_wrapper'):
                            t.api_wrapper.elitea = elitea_client
