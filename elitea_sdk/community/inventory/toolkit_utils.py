...
def get_llm_for_config(
    ...
    """
    Get LLM instance from EliteA client for entity extraction.
...
def get_source_toolkit(toolkit_config: Dict[str, Any]):
    ...
    Example:
        ...
        >>> toolkit = get_source_toolkit(config)
    """
    from elitea_sdk.community.inventory.filesystem_toolkit import FilesystemToolkit
    from elitea_sdk.community.toolkits import AVAILABLE_TOOLS
