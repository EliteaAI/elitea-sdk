...
Extends LangChain's prebuilt SummarizationMiddleware with EliteA-specific features:
- Callback support
...
class SummarizationMiddleware(LangChainSummarizationMiddleware):
    """
    Extends LangChain's SummarizationMiddleware with EliteA-specific features.
    ...
    def __init__(
        ...
        **kwargs
        ...
        # EliteA-specific attributes (no multiple inheritance needed)
    ...
    def before_model(self, state: dict, config: dict) -> Optional[dict]:
        ...
        # Fire 'started' callback (EliteA-specific)
