...
Priority order:
1. Local FAQ files (elitea_sdk/tools/docs/faq/{toolkit}.md)
2. Remote GitHub documentation
3. Generic fallback FAQ

Example:
    from elitea_sdk.runtime.middleware.faq_fetcher import get_toolkit_faq
...
def _fetch_faq_from_local(toolkit_type: str) -> Optional[str]:
    ...
    Looks for FAQ files in: elitea_sdk/tools/docs/faq/{toolkit_type}.md
    ...
    try:
        ...
        # This file is in elitea_sdk/runtime/middleware/
        # FAQ files are in elitea_sdk/tools/docs/faq/
        current_file = Path(__file__)
        sdk_root = current_file.parent.parent.parent  # Go up to elitea_sdk/
