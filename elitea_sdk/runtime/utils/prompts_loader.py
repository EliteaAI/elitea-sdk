...
Prompts are loaded from markdown files in elitea_sdk/prompts/ directory.
"""
...
class PromptLoader:
    ...
    Usage:
        from elitea_sdk.runtime.middleware.prompt_constants import PromptLoader, PromptFile
    ...
    def _get_prompts_dir(cls) -> Path:
        ...
        if cls._prompts_dir is None:
            cls._prompts_dir = Path(elitea_sdk.__file__).parent / "docs" / "prompts"
