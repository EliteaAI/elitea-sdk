...
Run this script to populate the elitea_sdk/tools/docs/faq/ directory with FAQ content
...
def save_faq(toolkit_name, faq_content, output_dir):
    ...
    try:
        ...
        github_doc_url = f"https://github.com/EliteaAI/elitea.github.io/blob/main/docs/integrations/toolkits/{toolkit_name}_toolkit.md"
...
def main():
    ...
    # Use relative path from script location instead of importing elitea_sdk
    # This allows the script to work during build when package isn't installed
    # Script is at: elitea_sdk/runtime/utils/docs/fetch_toolkit_faqs.py
    # Need to go up to: elitea_sdk/
    script_dir = Path(__file__).parent  # elitea_sdk/runtime/utils/docs/
