"""
MCP Config Toolkit for EliteA SDK.
...
1. SDK config file (ELITEA_MCP_SERVERS_CONFIG environment variable)
...
def load_mcp_servers_config(config_path: Optional[str] = None) -> Dict[str, Any]:
    ...
    2. ELITEA_MCP_SERVERS_CONFIG environment variable
    ...
    if config_path is None:
        config_path = os.environ.get('ELITEA_MCP_SERVERS_CONFIG')
