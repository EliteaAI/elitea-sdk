...
class ArtifactWrapper(NonCodeIndexerToolkit):
    ...
    def list_files(self, bucket_name=None, folder: str = None, recursive: bool = False,
        ...
        base_url = getattr(self.elitea, 'base_url', '').rstrip('/')
        project_id = getattr(self.elitea, 'project_id', '')
    ...
    def read_file(self,
        ...
        Args:
            ...
            extra_params: JSON-encoded string of per-file-type options
                ...
                for Excel, or ``{"prompt": "Describe only the chart"}``
                ...
                "args_schema": create_model(
                    ...
                    extra_params=(Optional[str], Field(
                        description=(
                            ...
                            "'{\"prompt\":\"Describe only the chart axis labels\"}'. "
