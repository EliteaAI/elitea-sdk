...
from elitea_sdk.tools.vector_adapters.VectorStoreAdapter import VectorStoreAdapterFactory
...
class VectorStoreWrapperBase(BaseToolApiWrapper):
    ...
    def validate_toolkit(cls, values):
        ...
        if values.get('elitea') and values.get('embedding_model'):
            values['embeddings'] = values.get('elitea').get_embeddings(values.get('embedding_model'))
