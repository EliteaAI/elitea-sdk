...
from elitea_sdk.tools.utils.retry import is_server_error_retriable
...
from ..retrievers.EliteARetriever import EliteARetriever
...
def get_vectorstore(vectorstore_type, vectorstore_params, embedding_func=None):
    ...
    if vectorstore_type == "PGVector" and isinstance(vectorstore_params, dict):
        ...
        if conn_str.startswith("postgresql+psycopg:"):
            ...
            new_pgvector = True
        #
        sdk_options = vectorstore_params.pop("elitea_sdk_options", {})
        #
