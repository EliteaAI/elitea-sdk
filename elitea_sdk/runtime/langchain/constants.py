...
- Refer to support (https://docs.elitea.ai/support/contact-support/) in case of any issues detected during the tools execution and when you cannot fix it on runtime.
...
csv_text = elitea_client.artifact('bucket').get('data.csv').decode('utf-8')
