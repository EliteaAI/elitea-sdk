...
class EliteAPrompt:
    def __init__(self, elitea: Any, prompt: ChatPromptTemplate, name: str, description: str, llm_settings: dict):
        self.elitea = elitea
        self.prompt = prompt
        self.name = name
    ...
    def predict(self, variables: Optional[dict] = None):
        ...
        result = []
        for message in self.elitea.predict(messages, self.llm_settings, variables=elitea_vars):
