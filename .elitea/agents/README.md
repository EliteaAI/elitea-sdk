...
```yaml
toolkit_configs:
  - file: .elitea/tools/github.json      # Load from file
...
toolkit_configs:
  - file: .elitea/tools/github.json
  - file: .elitea/tools/jira.json
  - file: .elitea/tools/confluence.json
  - file: .elitea/tools/gitlab.json
  - file: .elitea/tools/slack.json
  # ... many more toolkits
---
```
...
```bash
# Run agent
elitea agent chat my-agent.agent.md

# Mount directory for filesystem access
elitea agent chat my-agent.agent.md --dir ./project

# Override model/temperature
elitea agent chat my-agent.agent.md --model gpt-4o --temperature 0.5

# Set step limit (overrides agent's step_limit)
elitea agent chat my-agent.agent.md --recursion-limit 100

# Show tool execution
elitea agent chat my-agent.agent.md -v default  # default verbosity
elitea agent chat my-agent.agent.md -v debug    # verbose LLM calls
elitea agent chat my-agent.agent.md -v quiet    # minimal output
```
