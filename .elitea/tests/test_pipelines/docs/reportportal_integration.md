# ReportPortal Integration for EliteA SDK Test Framework

This integration enables automatic reporting of test results from the EliteA SDK test framework to ReportPortal TMS (Test Management System).
...
export RP_LAUNCH="EliteA SDK Tests"      # Default launch name
...
Standalone client for ReportPortal API located in `.elitea/tests/rp_client_standalone/`:
...
cd .elitea/tests/rp_client_standalone
...
- [EliteA SDK Test Framework](../README.md)
