...
Unified runner for EliteA SDK pipeline tests. Replaces run_test.sh and run_all_suites.sh.
...
def main():
    parser = argparse.ArgumentParser(description="EliteA SDK Test Manager")
