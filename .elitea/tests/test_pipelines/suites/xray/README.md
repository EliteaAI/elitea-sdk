...
This test suite validates the functionality of the Xray Cloud toolkit integration with the EliteA SDK.
...
```
.elitea/tests/test_pipelines/configs/xray-config.json
```
...
### Run All Tests
```bash
bash .elitea/tests/test_pipelines/run_all_suites.sh -v suites/xray
```

### Run Individual Test
```bash
bash .elitea/tests/test_pipelines/run_test.sh --seed --setup suites/xray XR01
```

### Run Specific Test Range
```bash
# Run tests XR01 through XR04
bash .elitea/tests/test_pipelines/run_test.sh --seed --setup suites/xray XR01-XR04

# Run all positive tests (XR01-XR09)
bash .elitea/tests/test_pipelines/run_test.sh --seed --setup suites/xray XR01-XR09

# Run negative tests only (XR10-XR12)
bash .elitea/tests/test_pipelines/run_test.sh --seed --setup suites/xray XR10-XR12
```
...
- [EliteA SDK Toolkit Documentation](../../../../docs/tools/)
