...
This test suite validates the functionality of the Zephyr Essential (Zephyr Scale) toolkit integration with the EliteA SDK.
...
```
.elitea/tests/test_pipelines/configs/zephyr-essential-config.json
```
...
### Run All Tests
```bash
bash .elitea/tests/test_pipelines/run_all_suites.sh -v suites/zephyr_essential
```

### Run Individual Test
```bash
bash .elitea/tests/test_pipelines/run_test.sh --seed --setup suites/zephyr_essential ZE01
```

### Run Specific Test Range
```bash
# Run tests ZE01 through ZE07
bash .elitea/tests/test_pipelines/run_test.sh --seed --setup suites/zephyr_essential ZE01-ZE07
```
...
```bash
bash .elitea/tests/test_pipelines/run_test.sh -v --seed --setup suites/zephyr_essential ZE01
```
