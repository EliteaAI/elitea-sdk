...
Test suite for SharePoint toolkit under `elitea_sdk/tools/sharepoint/`.
...
- **Test List**: ${TEST_LIST_NAME} (default: `DO_NOT_DELETE_EliteATestList`) - SharePoint list for list operations
- **Test Folder**: ${TEST_FOLDER} (default: `Shared Documents/DO_NOT_DELETE_EliteATestFiles`) - Folder for file operations
...
- `TEST_LIST_NAME`: SharePoint list name for tests (default: DO_NOT_DELETE_EliteATestList)
- `TEST_FOLDER`: Folder path for file tests (default: Shared Documents/DO_NOT_DELETE_EliteATestFiles)
...
3. **Test List**: Create `DO_NOT_DELETE_EliteATestList` SharePoint list manually (required for list operations)
