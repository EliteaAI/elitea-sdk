...
These tests verify the following fixes in `elitea_sdk/runtime/tools/llm.py`:
...
**Commit**: https://github.com/EliteaAI/elitea-sdk/commit/e45a9003f0409117490af2c6d3dcd812329db235
**Issue**: #3068
**Component**: `elitea_sdk/runtime/tools/llm.py`
...
# - Find agents in .elitea/agents/ with structured_output
...
- **Commit**: https://github.com/EliteaAI/elitea-sdk/commit/e45a9003f0409117490af2c6d3dcd812329db235
- **Issue**: #3068
- **File**: `elitea_sdk/runtime/tools/llm.py`
- **Related Docs**: 
