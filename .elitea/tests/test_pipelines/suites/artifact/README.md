...
Comprehensive test suite for the artifact toolkit (`elitea_sdk/runtime/tools/artifact.py`). This suite validates all file storage and management operations including bucket creation, file operations, searching, and batch processing.
...
- **Toolkit Implementation**: `elitea_sdk/runtime/tools/artifact.py`
- **Configuration Schema**: `elitea_sdk/configurations/artifact.py` (if exists)
- **Test Framework**: `.elitea/tests/test_pipelines/README.md`
- **Legacy Specs**: `.elitea/tests/testcases/artifact/*.md`
...
For test execution instructions, see `.elitea/tests/test_pipelines/README.md`
