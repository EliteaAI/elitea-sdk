"""
Shared EliteA API clients and helpers for copy/link scripts.

Provides ENV_URLS, extract_list(), and EliteAAPI (apps, tools, configs, linking).
"""
...
class EliteAAPI:
    """EliteA REST API: apps, tools, configs, and linking."""
