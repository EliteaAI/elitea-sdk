...
The `get_commit_changes` tool allows you to retrieve detailed information about files changed in a specific GitHub commit. This tool is part of the EliteA SDK GitHub toolkit.
...
```python
from elitea_sdk.tools.github import EliteAGitHubAPIWrapper

# Initialize the wrapper
github_wrapper = EliteAGitHubAPIWrapper(
...
- PyGithub library (automatically installed with EliteA SDK)
