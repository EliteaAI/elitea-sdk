...
src/elitea_tools/github/api_wrapper.py::create_issue_on_project
\
```python
from src.elitea_tools.github import EliteAGitHubAPIWrapper
from pydantic import ValidationError

try:
    api = EliteAGitHubAPIWrapper(
...
src/elitea_tools/github/api_wrapper.py::update_issue_on_project
\
```python
from src.elitea_tools.github import EliteAGitHubAPIWrapper
from pydantic import ValidationError
