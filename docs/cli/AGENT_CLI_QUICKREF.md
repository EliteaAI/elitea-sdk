...
cat > .env <<'EOF'
# Platform
DEPLOYMENT_URL=https://your.elitea.ai
PROJECT_ID=123
API_KEY=your_key
...
elitea-cli agent show .github/agents/dev.agent.md

# Chat (toolkit auto-loaded from agent)
elitea-cli agent chat .github/agents/dev.agent.md
```
...
- **Complete Guide**: `elitea-sdk/docs/cli/AGENT_CLI_GUIDE.md`
- **Example Workflow**: `elitea-sdk/docs/cli/custom-agent-example.md`
- **Full Summary**: `AGENT_CLI_ENHANCEMENTS.md`
- **Example Files**:
  - `elitea-sdk/examples/agent-with-env-vars.agent.md`
  - `elitea-sdk/examples/env-example.env`
  - `elitea-sdk/examples/jira-config-with-env.json`
...
elitea-cli --debug agent show my-agent.agent.md
```
...
# Use explicit path
elitea-cli agent show path/to/agent.agent.md
```

**Toolkit not working:**
```bash
# Verify config is loaded
elitea-cli --debug agent chat my-agent

# Check toolkit auto-added
elitea-cli agent show my-agent  # Check Tools list
```
