"""
Setup script for elitea-sdk with custom build hooks.
...
class GenerateDocsCommand(Command):
    ...
    def run(self):
        ...
        scripts = [
            'elitea_sdk/runtime/utils/docs/generate_tool_code_docs.py',
            'elitea_sdk/runtime/utils/docs/fetch_toolkit_faqs.py',
        ]
